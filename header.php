...
<head>
	...
	<link rel="icon" href="../wp-content/themes/eats/assets/favicon.png" sizes="32x32">
	<?php wp_head(); ?>
</head>
	...
	<header id="masthead" class="site-header">
		<div class="header-wrapper">
			...
			<button id="menu-toggle" class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
				...
				<!--
					<svg class="open" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path fill="#fff" d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
					<svg class="close" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path  fill="#fff" d="M10 8.586L2.929 1.515 1.515 2.929 8.586 10l-7.071 7.071 1.414 1.414L10 11.414l7.071 7.071 1.414-1.414L11.414 10l7.071-7.071-1.414-1.414L10 8.586z"/></svg>
				-->
			</button>
